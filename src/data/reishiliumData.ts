...
export const reishiliumBenefits: Record<'en' | 'fr' | 'ar', BenefitItem[]> = {
  ar: [
    ...
    { title: "جودة DXN العالمية المعتمدة", desc: "مدعوم بخبرة عقود من الأبحاث العلمية والبيولوجية الحاصلة على كبرى شهادات الأمان العالمية." }
  ],
  en: [
...
export const reishiliumFAQs: Record<'en' | 'fr' | 'ar', FAQItem[]> = {
  ar: [
    ...
    },
    {
      ...
      a: "يتميز بجودته البيولوجية الفائقة، وصيغته الطبيعية الخالية تماماً من المواد الحافظة والملونات الاصطناعية، وسهولة امتصاصه العالية بفضل طحنه الخلوي المتقدم وخبرة دي إكس إن العميقة في علوم الفطور العضوية."
    },
    {
