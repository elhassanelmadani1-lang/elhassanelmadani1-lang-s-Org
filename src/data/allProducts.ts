...
export const allProducts: ProductDetails[] = [
  ...
  },
  {
    ...
    images: [
      "https://i.ibb.co/zT09XFLB/image.png",
      "https://i.ibb.co/cS98nqzv/image.png",
      "https://i.ibb.co/d4x3nJ4J/image.png",
      "https://i.ibb.co/24k1GZg/image.png"
    ],
    isBestSeller: false,
    isMostPopular: false,
    stock: "limited",
  ...
  },
  {
    ...
    translations: {
      ...
      ar: {
        ...
        details: "يحتوي ريشيليوم على أعلى تركيز لمركبات الجانوديرما الحيوية النشطة. يطرد السموم المعاد تدويرها، يقوي الكبد والكلى والقلب، ويهدئ الأعصاب المتعبة."
      }
    }
  },
  {
  ...
  },
  {
    ...
    images: ["https://i.ibb.co/v4tJcg2w/image.png", "https://i.ibb.co/s9BFgkLm/image.png"],
    isBestSeller: true,
    isMostPopular: true,
    stock: "limited",
    benefitsList: {
      en: ["Spirulina + Reishi + Morinzhi + Cordyceps + Lion's Mane", "The ultimate DXN Golden Five combo", "Complete cellular regeneration and longevity", "Save 300 MAD + Free Shipping"],
      fr: ["Pack Golden Five complet", "Régénération cellulaire absolue", "Élimination totale des toxines", "Économisez 300 MAD + Livraison Gratuite"],
      ar: ["الفطر الريشي + السبيرولينا + المورينزي + الكورديسبس + عرف الأسد", "الخماسي الذهبي المتكامل من دي إكس إن", "إعادة بناء خلايا الجسم بالكامل وتعزيز المناعة", "توفير 300 درهم + شحن مجاني للمنزل"]
    },
    ingredientsList: {
      en: ["DXN Pure Spirulina", "DXN Reishi Gano (RG-90 Capsules)", "DXN Morinzhi Noni Juice", "DXN Cordyceps", "DXN Lion's Mane"],
      fr: ["Spiruline Pure DXN", "DXN Reishi Gano (RG-90 Gélules)", "Jus de Noni Morinzhi DXN", "Cordyceps DXN", "Lion's Mane DXN"],
      ar: ["أقراص السبيرولينا العضوية", "كبسولات فطر ريشي جانو (RG-90)", "عصير المورينزي الطبيعي", "فطر الكورديسبس الفاخر", "فطر عرف الأسد العضوي"]
    },
    translations: {
      en: {
        name: "DXN Golden Five Pack (الخماسي الذهبي)",
        subtitle: "The Ultimate Cellular Rejuvenation & Longevity Set",
        desc: "The supreme combination of DXN's 5 legendary bio-active superfoods (including Reishi RG-90 capsules). Together, they promote full-body detoxification, enhance cell metabolism, and strengthen defenses.",
        details: "This legendary set combines Reishi RG-90 Capsules (cellular cleaning & detox), Spirulina (alkaline nutrition), Morinzhi (enzymes & digestion), Cordyceps (energy & lungs), and Lion's Mane (nervous system & brain)."
      },
      fr: {
        name: "Le Khoumassi Ed-Dahabi (الخماسي الذهبي)",
        subtitle: "Le Pack Botanique Sacré de Longévité",
        desc: "L'association suprême des 5 superaliments légendaires de DXN avec le Reishi Gano (RG-90 Gélules). Agit en synergie parfaite pour purifier le sang, régénérer les cellules et booster l'énergie vitale.",
        details: "Comprend le Reishi Gano RG-90 Gélules (détoxifiant), la Spiruline (reine des algues), le Jus Morinzhi (enzymes actifs), le Cordyceps (vitalité et poumons) et le Lion's Mane (mémoire et système nerveux)."
      },
      ar: {
        name: "الخماسي الذهبي DXN (الكامل)",
        subtitle: "الباقة الأقوى عالمياً للصحة والتشافي الذاتي للخلية",
        desc: "التوليفة الأسطورية لخمسة من أرقى الأغذية الحيوية من DXN مع كبسولات فطر ريشي (RG-90) الفاخرة. تعمل معاً بالتكامل والتعاضد لتطهير خلايا الجسم من السموم وبناء جدار مناعي متين.",
        details: "تتكون الباقة من كبسولات فطر ريشي جانو RG-90 (لطرد السموم وتجديد الخلايا)، السبيرولينا (غذاء السوبر الشامل)، عصير المورينزي (ملك الأنزيمات والقولون)، فطر الكورديسبس (رئة وقلب الجسم وعلاج التعب)، وفطر عرف الأسد (غذاء الجهاز العصبي والذاكرة)."
      }
    }
  },
  {
    ...
    images: ["https://i.ibb.co/1g172cC/image.png", "https://i.ibb.co/zMpQfd3/image.png"],
    isBestSeller: true,
    isMostPopular: false,
    stock: "limited",
    benefitsList: {
      en: ["Reishi Gano + Pure Spirulina + Morinzhi Juice", "The legendary DXN Golden Triangle", "Deep cellular detox and optimal body balance", "Save 181 MAD + Free Shipping"],
      fr: ["Pack Triangle d'Or complet", "Détox cellulaire profonde", "Équilibre acido-basique optimal", "Économisez 181 MAD + Livraison Gratuite"],
      ar: ["الفطر الريشي + السبيرولينا العضوية + عصير المورينزي الطبيعي", "المثلث الذهبي الأسطوري من دي إكس إن", "ديتوكس شامل وتوازن حمضي قلوي مثالي للجسم", "توفير 181 درهم + شحن مجاني للمنزل"]
    },
    ingredientsList: {
      en: ["DXN Reishi Gano (RG-90 Capsules)", "DXN Pure Spirulina", "DXN Morinzhi Noni Juice"],
      fr: ["DXN Reishi Gano (RG-90 Gélules)", "Spiruline Pure DXN", "Jus de Noni Morinzhi DXN"],
      ar: ["كبسولات فطر ريشي جانو (RG-90)", "أقراص السبيرولينا العضوية", "عصير المورينزي الطبيعي"]
    },
    translations: {
      en: {
        name: "DXN Golden Triangle Pack (المثلث الذهبي)",
        subtitle: "The Foundation of Holistic Health & Balance",
        desc: "The essential daily cellular nutrition combo. These three synergistic superfoods (including Reishi RG-90 capsules) cleanse blood, balance pH levels, and supply ultimate vitality.",
        details: "The Golden Triangle consists of Reishi RG-90 Capsules (cellular cleaning & detox), Spirulina (complete nutrition), and Morinzhi (digestion and enzymes). It forms the fundamental starting point for any holistic wellness journey."
      },
      fr: {
        name: "Le Triangle d'Or DXN (المثلث الذهبي)",
        subtitle: "La Base de la Santé Holistique",
        desc: "Le trio incontournable pour l'entretien cellulaire au quotidien avec le Reishi Gano (RG-90 Gélules). Purifie l'organisme, équilibre le pH corporel et apporte les micronutriments essentiels.",
        details: "Le Triangle d'Or réunit le Reishi Gano RG-90 Gélules (détoxifiant), la Spiruline (super-nutritive) et le Jus Morinzhi (enzymes actifs). C'est le pilier fondamental pour retrouver tonus et équilibre biologique durable."
      },
      ar: {
        name: "المثلث الذهبي DXN (الكامل)",
        subtitle: "الركيزة الأساسية للصحة المستدامة والحيوية اليومية",
        desc: "الباقة الثلاثية الأساسية لتغذية وتنظيف خلايا الجسم مع كبسولات فطر ريشي (RG-90) الفاخرة. تعمل هذه الأغذية الثلاثة معاً بتناغم تام لطرد السموم، ضبط قلوية الدم وتنشيط المناعة.",
        details: "يتكون المثلث الذهبي من كبسولات فطر ريشي جانو RG-90 (لطرد السموم وتجديد الخلايا)، السبيرولينا (غذاء متكامل يعوض النقص الغذائي)، وعصير المورينزي (للهضم، الأنزيمات والقولون). يمثل الانطلاقة الأساسية لأي خطة تشافي طبيعي."
      }
    }
  },
  {
...
},
{
  ...
  "translations": {
    ...
    "ar": {
      ...
      "desc": "مسحوق فطر بوريا (Wolfiporia cocos) النقي ذو القيمة الغذائية الاستثنائية. يستعمل في التقاليد الشرقية القديمة لتنقية الكلى وتنظيم سوائل الجسم وتهدئة الأعصاب.",
...
},
{
  ...
  "translations": {
    ...
    "ar": {
      ...
      "subtitle": "حبوب النعناع الطبيعية والريشي لتطهير الحلق",
