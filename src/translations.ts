...
export const translations: Record<LanguageCode, LanguagePack> = {
  ...
  es: {
    brandName: "Samira Naturale",
    brandSubtitle: "Productos Naturales de Bienestar DXN",
    heroTitle: "Revitalice su Salud con lo Mejor de la Naturaleza",
    heroSub: "Selección rigurosa de productos ecológicos DXN de alta gama para su higiene, energía y bienestar. Sienta la auténtica frescura natural directamente en su hogar.",
    shopNow: "Descubrir Productos",
    whyChooseUs: "¿Por qué elegir Samira Naturale?",
    whyChooseUsSub: "Le ofrecemos las creaciones más puras de DXN, pionero mundial en la investigación del Ganoderma, para su salud e higiene.",
    pureTitle: "100% Orgánico y Seguro",
    pureDesc: "Libre de aditivos sintéticos, colorantes artificiales y conservantes químicos. Solo ingredientes puramente orgánicos.",
    dxnTitle: "Calidad DXN Certificada",
    dxnDesc: "Productos auténticos directamente de fuentes oficiales, con todas las garantías sanitarias reglamentarias.",
    deliveryTitle: "Envío Local Rápido",
    deliveryDesc: "Envío express seguro a todo Marruecos, preparado con el máximo cuidado y amor para su bienestar.",
    ourProducts: "Nuestros Productos Destacados",
    ourProductsSub: "Comience un estilo de vida saludable hoy mismo con nuestros 3 esenciales de bienestar de DXN.",
    addToCart: "Añadir al Carrito",
    addedToCart: "¡Añadido!",
    aboutTitle: "Sobre Samira Naturale",
    aboutText1: "Bienvenido a Samira Naturale, su socio de confianza para soluciones premium de salud y bienestar de DXN. Mi nombre es Samira, y mi misión es compartir con nuestra comunidad los increíbles beneficios de los suplementos naturales y el cuidado de higiene orgánico certificado.",
    aboutText2: "Nos especializamos en los esenciales de DXN de renombre mundial enriquecidos con Ganoderma (hongo Reishi) y Espirulina. Al adoptar estos tesoros nutricionales, puede fortalecer su sistema inmunológico, aumentar su energía y lograr un estilo de vida equilibrado y radiante. Cada pedido se procesa rápidamente y se envía a su hogar en Marruecos con orientación personalizada.",
    cartTitle: "Su Carrito de Compras",
    cartClose: "Cerrar",
    cartEmpty: "Su carrito está vacío en este momento. ¡Comience a añadir productos naturales!",
    cartTotal: "Total General",
    checkoutName: "Su Nombre Completo *",
    checkoutNamePlaceholder: "Siham Alaoui",
    checkoutAddress: "Dirección de Entrega *",
    checkoutAddressPlaceholder: "Calle, Apartamento, Ciudad, Marruecos",
    checkoutPhone: "Número de Teléfono de WhatsApp *",
    checkoutPhonePlaceholder: "Ej: 0612345678",
    checkoutButton: "Confirmar Pedido por WhatsApp",
    formError: "Por favor, complete todos los campos obligatorios marcados con un asterisco (*).",
    orderCompletedText: "¡Gracias! Redirigiéndole a WhatsApp para completar su pedido...",
    itemText: "producto",
    whatsappAssistanceText: "¡Hola Samira! Me gustaría informarme sobre los productos DXN.",
    currency: "DH",
    quantity: "Cant",
    whatsappMessageHeader: "🟢 NUEVO PEDIDO - SAMIRA NATURALE 🟢",
    addressLabel: "📍 Dirección de Entrega",
    phoneLabel: "📞 Teléfono del Cliente",
    totalLabel: "💵 Montant Total",
    itemsLabel: "🛍️ Artículos pedidos"
  }
};
...
export const productsData: Record<string, any> = {
  ...
  eyeCream: {
    ...
    ar: {
      name: "كريم العينين الأصلي من DXN للهالات والتجاعيد",
      desc: "وداعاً للهالات السوداء ونظرة التعب! استعيدي سحر وبريق عينيك في 7 أيام فقط مع كريم DXN العلاجي الفاخر!",
      benefits: [
        "👁️ القضاء على الهالات السوداء العميقة: ينشط الدورة الدموية الدقيقة حول العين ليقضي على السواد والزرقة الناتجة عن السهر والتعب.",
        "✨ شد فوري وتنعيم التجاعيد: يرفع الجفون المتعبة ويملأ الخطوط الرقيقة وتجاعيد 'رجل الغراب' بشكل ملحوظ.",
        "💧 ترطيب عميق ومكثف: يغذي خلايا البشرة الحساسة ليعيد إليها المرونة المفقودة والنضارة المشرقة.",
        "🎈 إزالة الجيوب والانتفاخات الصباحية: يهدئ الانتفاخ تحت العين فوراً لتظهري بمظهر منتعش ومستيقظ كل صباح.",
        "🌿 طبيعي وعلاجي آمن 100%: تركيبة نباتية نادرة من شركة DXN العالمية، خالية من الكيماويات والبارابين ومناسبة للعيون الحساسة.",
        "💰 استثمار ذكي لجمالك: بديل حقيقي وآمن لحصص الفيلر والميزوتيرابي المكلفة في العيادات (504 درهم فقط لنتائج دائمة ومضمونة).",
        "🎁 عرض خاص والتوفير الممتاز اليوم: اشتري قطعتين بـ 890 درهم فقط عوض 1008 درهم ووفر 118 درهم مع شحن مجاني واستشارة متابعة مجانية!",
        "🚚 توصيل فابور مجاني والدفع عند الاستلام (حتى تشدي منتجك بيدك وتأكدي منه)!"
      ]
    }
  },
  faceSerum: {
...
allProducts.forEach(p => {
  ...
  const mappedObj = {
    ...
    es: {
      name: (p.translations as any).es?.name || p.translations.en.name,
      desc: (p.translations as any).es?.desc || p.translations.en.desc,
      benefits: (p.benefitsList as any).es || p.benefitsList?.en || []
    }
  };
...
productsData['potenzhi'] = {
  ...
  es: {
    name: "Cápsulas DXN Potenzhi",
    desc: "DXN Potenzhi ofrece una sinergia orgánica de élite de raíces de Tongkat Ali premium, Butea Superba y hongo Cordyceps activo.",
    benefits: ["Aumenta la resistencia física y la energía natural", "Sostiene la circulación sanguínea saludable", "Alivia la fatiga crónica y el cansancio", "Fórmula 100% orgánica y segura"]
  }
};
...
productsData['moricinia'] = {
  ...
  es: {
    name: "Jugo DXN Moricinia",
    desc: "Una bebida botánica concentrada de élite hecha de jugo de Morinda Citrifolia (Noni) fermentado 100% orgánico.",
    benefits: ["Confort digestivo e intestinal inigualable", "Rico en enzimas activas y vitaminas naturales", "Alivia la rigidez articular crónica", "Promueve la regularidad intestinal natural"]
  }
};
