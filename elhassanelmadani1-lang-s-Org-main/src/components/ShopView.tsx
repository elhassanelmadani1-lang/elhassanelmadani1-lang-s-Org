...
allProducts.forEach(p => {
  ...
  if (!exists) {
    ...
    if (['coffee', 'coffee3in1', 'lions-mane-coffee', 'non-dairy-creamer'].includes(key)) {
      category = 'coffee';
    } else if (['spirulina', 'ganocelium', 'cordyceps', 'reishilium', 'reishi_gano', 'potenzhi-30', 'potenzhi-90', 'black-cumin-plus', 'poria-s'].includes(key)) {
      ...
      category = 'foods';
    } else if (['cordypine', 'roselle', 'morinzhiJuice', 'limonzhi', 'zhitea', 'oozhi-tea', 'aloe-vita', 'lions-mane-oocha', 'apple-enzyme', 'oocha-ganoderma', 'moricinia-700', 'moricinia-285', 'oolong-tea', 'neph-v'].includes(key)) {
      category = 'drinks';
